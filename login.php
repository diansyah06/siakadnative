...
<head>
    ...
    <title>SMK PEMBANGUNAN BANDUNG BARAT | Log in</title>
...
<body class="hold-transition login-page" style="background-image: url('psb/asset/images/wal.jpg');
    ...
    <div class="login-box">
        <div class="login-logo">
            <h2><a href="#"><b>SISTEM INFORMASI AKADEMIK</b></a></h2>
            <P>
            <h3> SMK PEMBANGUNAN BANDUNG BARAT</h3>
            </P>
        </div><!-- /.login-logo -->
        <div class="login-box-body">
            ...
            <form action="" method="post">
                <div class="form-group has-feedback">
                    <input type="text" class="form-control" name='a' placeholder="Masukan Username" required>
