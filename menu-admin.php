    ...
    <ul class="sidebar-menu">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                <li><a href="index.php?view=identitas"><i class="fa fa-circle-o text-green"></i> Data Identitas
                        Sekolah</a></li>
                <li><a href="index.php?view=kurikulum"><i class="fa fa-circle-o text-yellow"></i> Data Kurikulum</a>
                </li>
                <li><a href="index.php?view=tahunakademik"><i class="fa fa-circle-o text-red"></i> Data Tahun
                        Akademik</a></li>
                ...
                <li><a href="index.php?view=statuspegawai"><i class="fa fa-circle-o text-yellow"></i> Data Status
                        Kepegawaian</a></li>
            </ul>
        </li>
        <li class="treeview">
            <a href="#"><i class="fa fa-user"></i> <span>Data Pengguna</span><i
            ...
            <ul class="treeview-menu">
                ...
                <li><a href="index.php?view=wakilkepala"><i class="fa fa-circle-o text-red"></i> Data Kepala Sekolah</a>
                </li>
        ...
        <li class="treeview">
            <a href="#"><i class="fa fa-tag"></i> <span>Data Akademik</span><i
                    class="fa fa-angle-left pull-right"></i></a>
            <ul class="treeview-menu">
                <li><a href="index.php?view=kelompokmapel"><i class="fa fa-circle-o text-green"></i> Data Kelompok
                        Mapel</a></li>
                <li><a href="index.php?view=matapelajaran"><i class="fa fa-circle-o text-yellow"></i> Data Mata
                        Pelajaran</a></li>
                <li><a href="index.php?view=jadwalpelajaran"><i class="fa fa-circle-o text-red"></i> Data Jadwal
                        Pelajaran</a></li>
                <li><a href="index.php?view=bahantugas"><i class="fa fa-circle-o text-blue"></i>Data Bahan dan Tugas</a>
                </li>
                <li><a href="index.php?view=kompetensidasar"><i class="fa fa-circle-o text-green"></i>Data Kompetensi
                        Dasar</a></li>
                <!--<li><a href="index.php?view=bahantugas"><i class="fa fa-circle-o"></i>Data Bobot Raport *</a></li>-->
                <li><a href="index.php?view=penilaiandiri"><i class="fa fa-circle-o text-yellow"></i>Data Penilaian
                        Diri</a></li>
                ...
                <li><a href="index.php?view=penilaianteman"><i class="fa fa-circle-o text-blue"></i>Data Penilaian
                        Teman</a></li>
            </ul>
        </li>
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                ...
                <li><a href="index.php?view=absensiswa"><i class="fa fa-circle-o text-yellow"></i> Absensi Siswa</a>
                </li>
                <li><a href="index.php?view=rekapabsensiswa"><i class="fa fa-circle-o text-red"></i> Rekap Absensi
                        Siswa</a></li>
            </ul>
        </li>

        <li class="treeview">
            <a href="#"><i class="fa fa-list"></i> <span>PPDB Online</span><i
                    class="fa fa-angle-left pull-right"></i></a>
            <ul class="treeview-menu">
                ...
                <li><a href="index.php?view=psbsmk"><i class="fa fa-circle-o text-green"></i> Data Pendaftar SMK</a>
                </li>
                <li><a href="index.php?view=psbsmp"><i class="fa fa-circle-o text-yellow"></i> Data Pendaftar SMP</a>
                </li>
            </ul>
        </li>
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                ...
                <li><a href="index.php?view=raportcetakuts"><i class="fa fa-circle-o text-yellow"></i> Cetak Raport
                        UTS</a></li>

                <li><a href="index.php?view=capaianhasilbelajar"><i class="fa fa-circle-o text-red"></i> Data Capaian
                        Belajar</a></li>
                <li><a href="index.php?view=extrakulikuler"><i class="fa fa-circle-o text-blue"></i> Data
                        Extrakulikuler</a></li>
                <li><a href="index.php?view=prestasi"><i class="fa fa-circle-o text-green"></i> Data Prestasi</a></li>
                <li><a href="index.php?view=raport"><i class="fa fa-circle-o text-yellow"></i> Data Nilai Raport</a>
                </li>
